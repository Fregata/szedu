...
<div class="row">
  <div class="large-12 columns">
    <div class="panel" style="height:100px;background-color:#008CBA;">
      <h1><font style="font-family:微软雅黑;font-size:36px;color:#FFFFFF;">优秀应用系统介绍--体质检测</font></h1>
    </div>
  </div>
</div>
...
<div class="row">
  ...
  <div class="greenborder"></div>
  <div class="greenborder"></div>
  <ul class="pricing-table" title="体质检测">
    
    <li class="title" style="text-align: center;">
      <img alt="img/H+_green.png" src="img/H+_green.png">体质检测特性介绍
    </li>
    ...
    <li class="bullet-item" style="text-align: right;">
    <div class="row">
      <div class="large-8 small-8 columns">
        <div class="hide-for-small">
          <h3>体质检测特性二</h3>
