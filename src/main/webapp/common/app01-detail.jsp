...
<div class="row">
  <div class="large-12 columns">
    <div class="panel" style="height:100px;background-color:#008CBA;">
      <h1><font style="font-family:微软雅黑;font-size:36px;color:#FFFFFF;">优秀应用系统介绍--绿色指标</font></h1>
    </div>
  </div>
</div>
...
<div class="row">
  ...
  <div class="greenborder"></div>
  <div class="greenborder"></div>
  <ul class="pricing-table" title="绿色指标">
    
    <li class="title" style="text-align: center;">
      <img alt="img/H+_green.png" src="img/H+_green.png">绿色指标特性介绍
    </li>
